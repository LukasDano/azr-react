    ...
    return (
        <div className={'flex flex-col gap-1'}>
            ...
            <input
                ...
                className={
                    'rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm transition outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30'
                }
            />
        </div>
    );
