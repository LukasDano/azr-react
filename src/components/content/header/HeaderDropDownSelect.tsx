        ...
        <div className="w-fit shrink-0" style={{ minWidth: minWidth ? `${minWidth}px` : '150px' }}>
            <Listbox value={selectedItem} onChange={onChange}>
                <div className="relative">
                    <ListboxButton className="relative w-full cursor-pointer rounded-lg border bg-white py-2 pr-10 pl-3 text-left shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-600 dark:text-white dark:shadow-gray-700">
                    ...
                    <ListboxOptions className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm dark:bg-gray-500">
                        {items.map((item) => (
                            <ListboxOption
                                key={item}
                                value={item}
