...
export const availableThemes: Record<string, ColorTheme> = {
    cyan: {
        ...
        dark: 'dark:bg-cyan-600 dark:hover:bg-cyan-700',
    },
    sky: {
        light: 'bg-sky-400 hover:bg-sky-500',
        dark: 'dark:bg-sky-600 dark:hover:bg-sky-700',
    },
    emerald: {
    ...
    lime: {
        ...
        dark: 'dark:bg-lime-600 dark:hover:bg-lime-700',
    },
    teal: {
        light: 'bg-teal-400 hover:bg-teal-500',
        dark: 'dark:bg-teal-600 dark:hover:bg-teal-700',
    },
    slate: {
        light: 'bg-slate-400 hover:bg-slate-500',
        dark: 'dark:bg-slate-600 dark:hover:bg-slate-700',
    },
    green: {
    ...
    violet: {
        light: 'bg-violet-400 hover:bg-violet-500',
        dark: 'dark:bg-violet-600 dark:hover:bg-violet-700',
    },
    amber: {
        light: 'bg-amber-400 hover:bg-amber-500',
        dark: 'dark:bg-amber-600 dark:hover:bg-amber-700',
    },
    rose: {
        light: 'bg-rose-400 hover:bg-rose-500',
        dark: 'dark:bg-rose-600 dark:hover:bg-rose-700',
    },
    indigo: {
        light: 'bg-indigo-400 hover:bg-indigo-500',
        dark: 'dark:bg-indigo-600 dark:hover:bg-indigo-700',
    },
    orange: {
    ...
    pink: {
        light: 'bg-pink-400 hover:bg-pink-500',
        dark: 'dark:bg-pink-600 dark:hover:bg-pink-700',
    },
    purple: {
        light: 'bg-purple-400 hover:bg-purple-500',
        dark: 'dark:bg-purple-600 dark:hover:bg-purple-700',
    },
    yellow: {
        light: 'bg-yellow-400 hover:bg-yellow-500',
        dark: 'dark:bg-yellow-600 dark:hover:bg-yellow-700',
    },
};
